...
interface TagFactory
{
     ...
     *
     * Another way is to check the name of the argument against the names in the TaskService Locator. With this method
    ...
    /**
     * Registers a service with the TaskService Locator using the FQCN of the class or the alias, if provided.
     *
     * When calling a tag's "create" method we always check the signature for dependencies to inject. If a parameter
     * has a typehint then the ServiceLocator is queried to see if a TaskService is registered for that typehint.
     *
