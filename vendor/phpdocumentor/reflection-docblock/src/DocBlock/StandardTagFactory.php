 ...
 *
 * This Factory also features a TaskService Locator component that is used to pass the right dependencies to the
...
final class StandardTagFactory implements TagFactory
{
    ...
    /**
     * @var mixed[] an array representing a simple TaskService Locator where we can store parameters and
    ...
    /**
     * Returns a copy of this class' TaskService Locator with added dynamic parameters,
